    ...
    <motion.div initial={{scaleY:0.4,opacity:0.5,y:80}} whileInView={{scaleY:1,opacity:1,y:0}} transition={{type:"spring",duration:0.5}} viewport={{once:true}} className='bg-white text-black pt-7 md:pt-12 px-5 md:px-16 pb-2'>
      <div className="flex md:flex-row flex-col gap-5 md:gap-3 pb-8">
        <div className=" flex flex-col gap-3 flex-[2]">
          <h1 className="text-4xl font-bold hover:text-teal-700">MIHU.</h1>
          <p>We Create new Possibilities for the connected!</p>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          ...
          <ul className="font-light flex flex-col gap-1">
            ...
            <li className="hover:text-black/60"><a href="/">Vendors List</a> </li>
            <li className="hover:text-black/60"><a href="/">Careers</a> </li>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          ...
          <ul className="font-light flex flex-col gap-1">
            <li className="hover:text-black/60"><a href="/">Used Furniture</a> </li>
            <li className="hover:text-black/60"><a href="/">Bedroom Furniture</a> </li>
            <li className="hover:text-black/60"><a href="/">Office Furniture List</a> </li>
            <li className="hover:text-black/60"><a href="/">Image Search</a> </li>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          ...
          <ul className="font-light flex flex-col gap-1">
            <li className="hover:text-black/60"><a href="/">Become a Vendor</a> </li>
            <li className="hover:text-black/60"><a href="/">Become a Seller</a> </li>
      ...
      <p className="text-center font-semibold">© 2023 MIHU™. All Rights Reserved.</p>
